...
export const testimonialsConfig: TestimonialsConfig = {
  ...
  testimonials: [
    ...
    {
      quote: "We trained our team through AccelerateX to integrate AI into daily operations. Within weeks, we saw measurable productivity improvements. Manual tasks were automated, content turnaround time reduced, and operational costs decreased across multiple departments. The ROI was clearly visible.",
      author: "Aman Gupta",
      role: "Operations Head",
      company: "Nextland Careers",
